...
<head>
  ...
  <title>Tráfego Pago Local e Automação | Especialista</title>
  ...
  <style>
    ...
    :root {
      --cor-fundo: #0a0a0a;
      --cor-fundo-secundario: #121212;
      --cor-texto: #e0e0e0;
      --cor-texto-titulo: #ffffff;
      --cor-cta-principal: #00e676; /* Verde Neon */
      --cor-cta-hover: #00c853;
    ...
    * {
    ...
    /* Provas Sociais (Testimonials Carousel) */
    .carousel-container {
      overflow-x: auto;
...
<body>
  <header class="hero">
    <div class="container">
      <img src="https://placehold.co/200x200/00e676/0a0a0a/png?text=SEU+LOGO" alt="Foto de Perfil" class="profile-img">
